...
class ExampleGenerator(Protocol):
    def generate(self, entry: WordEntry, scope: str = "", language: str = ""): ...

    def generate_isolated(self, entry: WordEntry, scope: str = "", language: str = ""): ...

    def correct_entry(self, entry: WordEntry, scope: str = "", language: str = ""): ...

    def correct_entry_isolated(self, entry: WordEntry, scope: str = "", language: str = ""): ...
...
class MeaningTranslator(Protocol):
